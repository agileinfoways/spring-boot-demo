...
This is an example project to show what Clean Architecture would look like (in Sprigg boot Java).
...
* open <http://localhost:8080/rest/api/swagger-ui.html/> and you should see some json
...
This example application is a simplified version of a real production application that we develop at Sky. The domain is a telecommunication domain. claim management system use cases:
